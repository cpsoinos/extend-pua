...
const Footer = () => {
  return (
    <footer className="flex text-white font-luloBold">
      ...
      <div className="w-full max-w-1/3 text-center text-xxs">
        © 2020 | ExtendPUA.org
      ...
      <div className="w-full max-w-1/3 text-right">
        ...
        <div className="space-x-4 mt-4 mb-2">
          <Button href="https://www.facebook.com/extendpua">
          ...
          <Button href="https://www.twitter.com/extendpua">
          ...
          <Button href="https://www.instagram.com/extendpua">
