      ...
      <div className="w-full sm:max-w-1/3 text-center mt-4 sm:mt-0 sm:text-right">
        ...
        <div className="space-x-4 mt-4 mb-2">
          <Button className="inline-block" href="https://www.facebook.com/extendpua">
            <img src="https://static.wixstatic.com/media/e316f544f9094143b9eac01f1f19e697.png/v1/fill/w_26,h_26,al_c,q_85,usm_0.66_1.00_0.01/e316f544f9094143b9eac01f1f19e697.jpg" loading="lazy" width="26" height="26" alt="Extend PUA on Facebook" />
          </Button>

          <Button className="inline-block" href="https://www.twitter.com/extendpua">
            <img src="https://static.wixstatic.com/media/9c4b521dd2404cd5a05ed6115f3a0dc8.png/v1/fill/w_26,h_26,al_c,q_85,usm_0.66_1.00_0.01/9c4b521dd2404cd5a05ed6115f3a0dc8.jpg" loading="lazy" width="26" height="26" alt="Extend PUA on Twitter" />
          </Button>

          <Button className="inline-block" href="https://www.instagram.com/extendpua">
            <img src="https://static.wixstatic.com/media/8d6893330740455c96d218258a458aa4.png/v1/fill/w_26,h_26,al_c,q_85,usm_0.66_1.00_0.01/8d6893330740455c96d218258a458aa4.jpg" loading="lazy" width="26" height="26" alt="Extend PUA on Instagram" />
          </Button>
        </div>
