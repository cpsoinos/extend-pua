...
const CongressPersonCard = (props: CongressPersonCardProps) => {
  ...
  const imageClasses = classNames('h-auto flex-none rounded-t-none rounded-l object-cover overflow-hidden border-l-8', {
  ...
  return (
    <div className="flex w-full">
      ...
      <div className="border border-gray-400 bg-white rounded-r p-4 leading-normal w-full">
        <div className="mb-4">
          ...
          <p className="text-gray-700 text-base text-xs italic">Up for re-election in {upForReElection}</p>
        </div>
